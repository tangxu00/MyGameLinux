/*************************************************************************
    ...
    > Created Time: 2017年07月27日 星期四 10时50分30秒
 ************************************************************************/
...
int syn_err(char*);
/*
 * prupose: determine the shell should execute a command
 * returns: 1 for yes,0 for no
 * details:if in THEN_BLOCK and if_result was SCUESS then yes
...
/*purpose: handles syntax error in control structure
 * details:resets state to NEUTRSL
